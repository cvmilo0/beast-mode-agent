...
import type { OutputController, OutputDeviceConfig } from "../OutputController.js";
...
export declare class MediaDeviceOutput implements OutputController, PlaybackEventTarget {
    ...
    static create({ sampleRate, format, outputDeviceId, workletPaths, libsampleratePath, }: FormatConfig & OutputConfig & AudioWorkletConfig): Promise<MediaDeviceOutput>;
    private volume;
    private interrupted;
