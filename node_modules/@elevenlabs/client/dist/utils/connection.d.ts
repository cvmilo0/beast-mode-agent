export { Language, DelayConfig, FormatConfig, DisconnectionDetails, OnDisconnectCallback, OnMessageCallback, SessionConfig, parseFormat, } from "./BaseConnection.js";
...
export declare class Connection {
    static create(config: SessionConfig): Promise<import("./BaseConnection.js").BaseConnection>;
}
