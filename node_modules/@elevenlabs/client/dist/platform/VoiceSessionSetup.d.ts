 ...
 */
export declare function setupInputOutput(options: Options, connection: BaseConnection): Promise<Omit<VoiceSessionSetupResult, "connection">>;
/**
 * Web platform session setup strategy.
 * Creates a connection and sets up input/output based on the connection type.
 */
export declare function webSessionSetup(options: Options): Promise<VoiceSessionSetupResult>;
/**
 ...
 */
export declare let setupStrategy: VoiceSessionSetupStrategy;
/**
